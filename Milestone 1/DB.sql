...
Season           VARCHAR(255),
PRIMARY KEY (PlayerFName, PlayerLName),
FOREIGN KEY (PlayerFName, PlayerLName) REFERENCES Player (FName, LName)
ON UPDATE CASCADE  ON DELETE CASCADE,
...
ON UPDATE CASCADE ON DELETE CASCADE
-- FOREIGN KEY (MatchSeason) REFERENCES Matchs (Season)
-- ON UPDATE CASCADE ON DELETE CASCADE
);
...
-- ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (Date) REFERENCES Matchs (Date)
ON UPDATE CASCADE ON DELETE CASCADE
);
